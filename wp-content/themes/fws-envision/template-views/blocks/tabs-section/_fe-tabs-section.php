				...
				<div class="tabs-section__tab-content-box">
					<div class="tabs-section__tab-content-upper-box">
						<div class="tabs-section__tab-content-text-box">
							...
							<h4 class="tabs-section__tab-content-heading">3D virtual tours for retailers, showrooms, party planners, restaurants, and more</h4>
							<h5 class="tabs-section__tab-content-heading--small">Bring them into your space with a single click</h5>
							<p class="tabs-section__tab-content-paragraph">
				...
				<div class="tabs-section__tab-content-box">
					<div class="tabs-section__tab-content-upper-box">
						<div class="tabs-section__tab-content-text-box">
							...
							<h4 class="tabs-section__tab-content-heading">Intricate construction photo documentation that details all stages and system elements.</h4>
							<h5 class="tabs-section__tab-content-heading--small">The power to see through walls and ceilings</h5>
							<p class="tabs-section__tab-content-paragraph">
